...
EXPANSION: list[OpenMLTaskSpec] = [
    ...
    OpenMLTaskSpec("connect-4", 40668, "class", "accuracy", True, "multiclass", "OpenML connect-4 (cc18,amlb-clf)"),
    OpenMLTaskSpec("cps88wages", 44984, "wage", "rmse", False, "regression", "OpenML cps88wages (ctr23)"),
    OpenMLTaskSpec("diabetes130us", 4541, "readmitted", "accuracy", True, "multiclass", "OpenML Diabetes130US (amlb-clf)"),
    OpenMLTaskSpec("diamonds", 42225, "price", "rmse", False, "regression", "OpenML diamonds (amlb-reg,ctr23)"),
    OpenMLTaskSpec("dna", 40670, "class", "accuracy", True, "multiclass", "OpenML dna (cc18,amlb-clf)"),
    OpenMLTaskSpec("elevators", 216, "Goal", "rmse", False, "regression", "OpenML elevators (amlb-reg)"),
    OpenMLTaskSpec("fabert", 41164, "class", "accuracy", True, "multiclass", "OpenML fabert (amlb-clf)"),
    OpenMLTaskSpec("fifa", 45012, "wage_eur", "rmse", False, "regression", "OpenML fifa (ctr23)"),
    OpenMLTaskSpec("first-order-theorem-proving", 1475, "Class", "accuracy", True, "multiclass", "OpenML first-order-theorem-proving (cc18,amlb-clf)"),
    OpenMLTaskSpec("fps-benchmark", 44992, "FPS", "rmse", False, "regression", "OpenML fps_benchmark (ctr23)"),
    OpenMLTaskSpec("gesturephasesegmentationprocessed", 4538, "Phase", "accuracy", True, "multiclass", "OpenML GesturePhaseSegmentationProcessed (cc18,amlb-clf)"),
    ...
    OpenMLTaskSpec("har", 1478, "Class", "accuracy", True, "multiclass", "OpenML har (cc18)"),
    ...
    OpenMLTaskSpec("isolet", 300, "class", "accuracy", True, "multiclass", "OpenML isolet (cc18)"),
    OpenMLTaskSpec("jannis", 41168, "class", "accuracy", True, "multiclass", "OpenML jannis (amlb-clf)"),
    ...
    OpenMLTaskSpec("jungle-chess-2pcs-raw-endgame-complete", 41027, "class", "accuracy", True, "multiclass", "OpenML jungle_chess_2pcs_raw_endgame_complete (cc18,amlb-clf)"),
    ...
    OpenMLTaskSpec("letter", 6, "class", "accuracy", True, "multiclass", "OpenML letter (cc18)"),
    ...
    OpenMLTaskSpec("mfeat-factors", 12, "class", "accuracy", True, "multiclass", "OpenML mfeat-factors (cc18,amlb-clf)"),
    OpenMLTaskSpec("mfeat-fourier", 14, "class", "accuracy", True, "multiclass", "OpenML mfeat-fourier (cc18)"),
    OpenMLTaskSpec("mfeat-karhunen", 16, "class", "accuracy", True, "multiclass", "OpenML mfeat-karhunen (cc18)"),
    OpenMLTaskSpec("mfeat-morphological", 18, "class", "accuracy", True, "multiclass", "OpenML mfeat-morphological (cc18)"),
    OpenMLTaskSpec("mfeat-zernike", 22, "class", "accuracy", True, "multiclass", "OpenML mfeat-zernike (cc18)"),
    ...
    OpenMLTaskSpec("okcupid-stem", 42734, "job", "accuracy", True, "multiclass", "OpenML okcupid-stem (amlb-clf)"),
    ...
    OpenMLTaskSpec("pendigits", 32, "class", "accuracy", True, "multiclass", "OpenML pendigits (cc18)"),
    ...
    OpenMLTaskSpec("satimage", 182, "class", "accuracy", True, "multiclass", "OpenML satimage (cc18)"),
    OpenMLTaskSpec("segment", 40984, "class", "accuracy", True, "multiclass", "OpenML segment (cc18,amlb-clf)"),
    OpenMLTaskSpec("shuttle", 40685, "class", "accuracy", True, "multiclass", "OpenML shuttle (amlb-clf)"),
    ...
    OpenMLTaskSpec("splice", 46, "Class", "accuracy", True, "multiclass", "OpenML splice (cc18)"),
    OpenMLTaskSpec("sylvine", 41146, "class", "roc_auc", True, "binary", "OpenML sylvine (amlb-clf)"),
    OpenMLTaskSpec("texture", 40499, "Class", "accuracy", True, "multiclass", "OpenML texture (cc18)"),
    ...
    OpenMLTaskSpec("volkert", 41166, "class", "accuracy", True, "multiclass", "OpenML volkert (amlb-clf)"),
    OpenMLTaskSpec("wall-robot-navigation", 1497, "Class", "accuracy", True, "multiclass", "OpenML wall-robot-navigation (cc18)"),
